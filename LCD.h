...
#define LCD_CMD_CLEAR 		0x01u //based on LCD registers, 00000001
#define LCD_CMD_HOME 			0x02u // 00000010
...
// Settings for LCD CD Shift (shift cursor without changing data)
...
// Address for each line on the LCD
...
#define LCD_BUS_BIT								(0xF << 8) // PA8 - PA11
#define LCD_BUS_BIT_POS						8

#define LCD_PORT_BITS							(LCD_RS_BIT | LCD_E_BIT | LCD_BUS_BIT) // bits 6-11, 0x07E0
...
#define MAX_LCD_BUFSIZ 81 // 80 characters + null character
